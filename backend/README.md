...
Install handson.keycloak with uv.

```shell
uv add handson.keycloak
```
...
- [Issue tracker](https://github.com/collective/keycloak-and-plone/issues)
- [Source code](https://github.com/collective/keycloak-and-plone/)
...
Generated from the [`cookieplone-templates`  template](https://github.com/plone/cookieplone-templates/tree/main/) on 2025-05-06 21:39:09.. A special thanks to all contributors and supporters!
